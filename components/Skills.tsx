...
const skills = [
  "SMM", "Copywriting", "Next.js", "Git", "React", "TypeScript", "Tailwind CSS", "Framer Motion", "Node.js", "Express", "MongoDB", "PostgreSQL", "Figma", "Adobe XD", "Photoshop"
];
    ...
    <section className="space-y-8">
      ...
      >
        ...
        <p className="max-w-3xl text-slate-400">
          Marketing va dasturlash sohasidagi tajribam bilan yuqori sifatli loyihalar yarataman.
        </p>
      </motion.div>
